...
extern uint16_t V_MIN;				// 40000 Constant of the minimum voltage for start balancing, first condition for balancing. Two conditions at least should be happening for balancing (Balancing -> Stop chargin
extern uint16_t V_BALANCING;		// 41950 Constant of the limit voltage to start balancing, it has no other conditions for balancing
